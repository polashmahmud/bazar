...
<template>
    <AuthBase title="একটি অ্যাকাউন্ট তৈরি করুন" description="আপনার অ্যাকাউন্ট তৈরি করতে নিচে আপনার তথ্য লিখুন">
        ...
        <Form v-bind="RegisteredUserController.store.form()" :reset-on-success="['password', 'password_confirmation']"
            ...
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="password_confirmation" type="password" required :tabindex="4" autocomplete="new-password"
                        name="password_confirmation" placeholder="পাসওয়ার্ড নিশ্চিত করুন" />
            ...
            <div class="text-center text-sm text-muted-foreground">
                ...
                <TextLink :href="login()" class="underline underline-offset-4" :tabindex="6">লগইন করুন</TextLink>
            </div>
        </Form>
    </AuthBase>
</template>
