            ...
            >
              <div class="p-4">
                <div class="flex items-start space-x-4">
                  <!-- Item Image -->
                  <div class="w-16 h-16 sm:w-20 sm:h-20 bg-gray-100 dark:bg-gray-700 rounded-lg flex-shrink-0">
                    <img
                  ...
                  <div class="flex-1 min-w-0">
                    <h4 class="text-base font-medium text-gray-900 dark:text-white truncate mb-1">
                      {{ item.name }}
                    </h4>
                  ...
                  <div class="flex flex-col space-y-3">
                    ...
                    <button
                      ...
                      class="text-blue-500 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 p-1.5 rounded-full"
                      title="Edit item"
                    >
                    ...
                    <button
                      ...
                      class="text-green-500 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/20 p-1.5 rounded-full"
                      title="Mark as done"
                    >
                      <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    ...
                    <button
                      ...
                      class="text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 p-1.5 rounded-full"
